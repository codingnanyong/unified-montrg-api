"""SQLAlchemy model for the `mart_productivity_by_ph_machine` table."""
...
class MartProductivityByPhMachine(Base):
    """Represents a row in the `mart_productivity_by_ph_machine` table."""

    __tablename__ = "mart_productivity_by_ph_machine"
    ...
    def __repr__(self) -> str:
        return (
            f"MartProductivityByPhMachine(business_date={self.business_date}, "
